...
export default class TarifIcon extends Component {
    ...
    render() {
        ...
        switch (ratio) {
            case 0:
                source = require('../images/drawable-ldpi/ic_tariff_R.png');
                break;
            /*case 1:
            ...
            case 1.5:
                ...
                break;*/
            case 2:
                source = require('../images/drawable-mdpi/ic_tariff_R.png');
                break;
            case 3:
                source = require('../images/drawable-mdpi/ic_tariff_R.png');
                break;
